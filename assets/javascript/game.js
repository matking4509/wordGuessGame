...
var wordObj = {
    ...
    hint : ["He's a cranky old nephew with Good News for all!",
            ...
            "She's Cute, She's Rich, She Looooves Pink... She's the intern!",
            "He loves to bend things, and rocks a sweet soul patch.",
            "His ass is shiney, biteable, and saves ships in the night.",
            "He's Squishy, He's Green, He's everyone's favourite fluffer.",
            "He's insane in the function main(), Don't make him mad... he'll STAB!",
            "He owns stock in Velour Inc. Was not killed by Snu Snu.",
            "And why not?",
            "He is the cutest little rocket fuel poop machine ever"],
    image : ["professor.png",
             "fry.png",
             "leela.png",
             "amywong.png",
